...
dim_step_cut = [0.7,0.9]; // [depth, inside_width]
...
pcb_col_pin_clr = [0.4,0.4]; // pin dia,height clearance
...
module boxcut(side=1)
{
  difference()
  {
    ...
    cube(dim_box_inner+[-dim_box_thick*3,-dim_box_thick*3,4*dim_box_thick],center=true);
  }
}
